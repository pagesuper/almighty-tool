...
var I18n = /** @class */ (function () {
    ...
    I18n.prototype.t = function (key, options) {
        ...
        var path = key.split('.');
        var template = (_e = (0, get_1.default)(this.messages, tslib_1.__spreadArray([lang], path, true))) !== null && _e !== void 0 ? _e : (0, get_1.default)(this.messages, tslib_1.__spreadArray([fallbackLang], path, true));
