...
var index_1 = tslib_1.__importDefault(require("./en-US/index"));
var index_2 = tslib_1.__importDefault(require("./zh-CN/index"));
var messages = {
...
var I18n = /** @class */ (function () {
    ...
    I18n.prototype.setMessages = function (messages) {
        this.messages = messages;
    };
    I18n.prototype.mergeMessages = function (messages) {
        this.messages = (0, deepmerge_1.default)(this.messages, messages);
    };
    ...
    I18n.prototype.t = function (key, options) {
        ...
        var path = key.split('.');
        var template = (_e = lodash_es_1.default.get(this.messages, tslib_1.__spreadArray([lang], path, true))) !== null && _e !== void 0 ? _e : lodash_es_1.default.get(this.messages, tslib_1.__spreadArray([fallbackLang], path, true));
...
exports.i18nConfig = {
    ...
    defaultLang: exports.defaultLang,
};
