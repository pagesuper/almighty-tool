...
var cryptoUtil = {
    ...
    longPublicEncrypt: function (publicKey, data, options) {
        ...
        var joinSeparator = (_b = options.joinSeparator) !== null && _b !== void 0 ? _b : DEFAULT_JOIN_SEPARATOR;
        var _c = this.generateAesKeyAndIV(), aesKey = _c.key, iv = _c.iv;
        return {
    ...
    longPrivateDecrypt: function (privateKey, encryptedAesKey, encryptedData, options) {
        var _a, _b;
        if (options === void 0) { options = {}; }
        var decryptAlgorithm = (_a = options.algorithm) !== null && _a !== void 0 ? _a : DEFAULT_KEY_ENCRYPTION_SCHEME;
        var joinSeparator = (_b = options.joinSeparator) !== null && _b !== void 0 ? _b : DEFAULT_JOIN_SEPARATOR;
        var aesKey = this.privateDecrypt(privateKey, encryptedAesKey, decryptAlgorithm);
        var _c = this.splitJoinedStrings(encryptedData, joinSeparator), iv = _c[0], data = _c[1];
