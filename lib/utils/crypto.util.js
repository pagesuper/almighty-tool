...
var cryptoUtil = {
    ...
    // 公钥加密
    publicEncrypt: function (publicKey, data) {
    ...
    longPrivateDecrypt: function (privateKey, encryptedAesKey, encryptedData) {
        var aesKey = this.privateDecrypt(privateKey, encryptedAesKey);
    ...
    splitJoinedStrings: function (str) {
