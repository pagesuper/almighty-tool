...
var padEnd_1 = tslib_1.__importDefault(require("lodash-es/padEnd"));
var numberUtil = {
    /** 格式化1个浮点数 */
    ...
    splitFloat: function (value, options) {
        ...
        var floatPart = (ignoreTailZeros ? s[1] || '' : (0, padEnd_1.default)(s[1] || '', maxTailsCount, '0')).slice(0, maxTailsCount);
        return {
            integer: s[0] || '0',
            float: floatPart,
