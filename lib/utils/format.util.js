...
exports.formatUtil = exports.regExps = exports.DEFAULT_LOCALE = void 0;
var tslib_1 = require("tslib");
var keys_1 = tslib_1.__importDefault(require("lodash-es/keys"));
...
var formatUtil = {
    isChinaMobileNumber: function (mobileNumber) {
        return exports.regExps['mobile-number-china'].test(mobileNumber);
    },
    isMobileNumber: function (mobileNumber, region) {
        if (region === void 0) { region = '+86'; }
        if (region === '+86') {
    ...
    cssStyleObjectToString: function (style) {
        var _this = this;
        var styles = [];
        (0, keys_1.default)(style).forEach(function (key) {
    ...
    formatBytes: function (bytes, options) {
        ...
        var separator = (_a = options.separator) !== null && _a !== void 0 ? _a : ' ';
        var decimals = (_b = options.decimals) !== null && _b !== void 0 ? _b : 2;
        if (bytes === 0) {
