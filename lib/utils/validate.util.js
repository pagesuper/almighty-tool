...
exports.Validator = exports.validateUtil = exports.ValidateSchema = exports.ARRAY_ITEMS_BASIC_TYPE_KEY = exports.ValidateResponseInstance = void 0;
...
var cloneDeep_1 = tslib_1.__importDefault(require("lodash-es/cloneDeep"));
var get_1 = tslib_1.__importDefault(require("lodash-es/get"));
var last_1 = tslib_1.__importDefault(require("lodash-es/last"));
var omit_1 = tslib_1.__importDefault(require("lodash-es/omit"));
var reduce_1 = tslib_1.__importDefault(require("lodash-es/reduce"));
var transform_1 = tslib_1.__importDefault(require("lodash-es/transform"));
var pick_1 = tslib_1.__importDefault(require("lodash-es/pick"));
var isEmpty_1 = tslib_1.__importDefault(require("lodash-es/isEmpty"));
var index_1 = require("../i18n/index");
var format_util_1 = require("./format.util");
var string_util_1 = tslib_1.__importDefault(require("./string.util"));
var ValidateResponseInstance = /** @class */ (function () {
    function ValidateResponseInstance(options) {
        /** 是否成功 */
        this.success = true;
     ...
     * @param error 错误
     */
    ValidateResponseInstance.prototype.addError = function (error) {
        (this.errors || (this.errors = [])).push(error);
        this.success = false;
    };
    return ValidateResponseInstance;
}());
exports.ValidateResponseInstance = ValidateResponseInstance;
exports.ARRAY_ITEMS_BASIC_TYPE_KEY = '__items__';
...
var validateUtil = {
    ...
    getErrors: function (error, options) {
        ...
        var values = (_b = options === null || options === void 0 ? void 0 : options.values) !== null && _b !== void 0 ? _b : {};
        if (typeof error === 'object' && error !== null && 'errors' in error) {
            return Reflect.get(error, 'errors').map(function (err) {
                var field = (0, get_1.default)(err, 'field');
                var fieldValue = field ? (0, get_1.default)(values, field) : undefined;
                return {
                    field: field,
        ...
        return [
            {
                ...
                fieldValue: (_c = options === null || options === void 0 ? void 0 : options.fieldValue) !== null && _c !== void 0 ? _c : ((options === null || options === void 0 ? void 0 : options.field) ? (0, get_1.default)(values, options.field) : undefined),
                model: model,
            },
        ];
    },
    ...
    transform: function (values, rules) {
        ...
        function doTransform(values, parentPath) {
            var valuesType = Array.isArray(values) ? 'array' : 'object';
            return (0, transform_1.default)(values, function (result, value, key) {
                var path = "".concat(parentPath ? "".concat(parentPath, ".") : '').concat(key);
                var isSimpleArray = typeof value === 'object' &&
                    value !== null &&
                    Array.isArray(value) &&
                    typeof value[0] !== 'object' &&
                    !Array.isArray(value[0]);
                if (isSimpleArray) {
                    path = "".concat(path, ".").concat(exports.ARRAY_ITEMS_BASIC_TYPE_KEY);
                }
     ...
     * @returns 校验结果
     */
    validate: function (rules, values, options, callback) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var model, usingValues, schema, transformedValues, error_1, mergedValues;
            var _a, _b, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        model = (_a = options === null || options === void 0 ? void 0 : options.model) !== null && _a !== void 0 ? _a : 'Base';
                        usingValues = (0, omit_1.default)((options === null || options === void 0 ? void 0 : options.pickKeys) ? (0, pick_1.default)(values, options.pickKeys) : values, (_b = options === null || options === void 0 ? void 0 : options.omitKeys) !== null && _b !== void 0 ? _b : []);
                    ...
                    case 2:
                        _d.sent();
                        return [2 /*return*/, new ValidateResponseInstance({
                                success: true,
                                values: transformedValues,
                            })];
                    case 3:
                        error_1 = _d.sent();
                        mergedValues = usingValues;
                        return [2 /*return*/, new ValidateResponseInstance({
                                success: false,
                                values: mergedValues,
                                errors: validateUtil.getErrors(error_1, {
                                    model: model,
                                    i18n: (_c = options === null || options === void 0 ? void 0 : options.i18n) !== null && _c !== void 0 ? _c : index_1.i18nConfig.i18n,
                                    lang: options === null || options === void 0 ? void 0 : options.lang,
                                    values: mergedValues,
                                }),
                            })];
     ...
     * @returns 校验规则
     */
    recursiveGetLocaleRules: function (rules, flatRules, options) {
        var _a, _b;
        ...
        Object.keys(rules).forEach(function (fieldKey) {
            var _a, _b;
            var fieldRule = rules[fieldKey];
            var fieldRules = Array.isArray(fieldRule) ? fieldRule : [fieldRule];
            var defaultFields = (0, reduce_1.default)(fieldRules, function (result, rule) {
                if (rule.type === 'array' && rule.defaultField) {
                    if (Array.isArray(rule.defaultField)) {
                        result.push.apply(result, rule.defaultField);
                    }
                    else {
            ...
            var defaultFieldType = (_b = (_a = defaultFields[0]) === null || _a === void 0 ? void 0 : _a.type) !== null && _b !== void 0 ? _b : undefined;
            fieldRules.forEach(function (rule) {
                ...
                if (rule.fields) {
                    ...
                    var defaultFields_1 = Array.isArray(rule.defaultField)
                        ? rule.defaultField
                        : rule.defaultField
                            ? [rule.defaultField]
                            : [];
                    defaultFields_1.forEach(function (defaultField) {
                        var _a;
                        if (defaultField) {
                            if (defaultField.type === 'object' && defaultField.fields) {
                                ...
                                if (defaultField.path) {
                                    validateUtil.recursiveGetLocaleRules((_a = {},
                                        _a[defaultField.path] = defaultField,
                                        _a), flatRules, options);
                                }
                            }
                        }
                    });
                ...
                if (rule.path) {
                    var flatRule = (0, cloneDeep_1.default)(rule);
                    delete flatRule.fields;
                    delete flatRule.defaultField;
                    var flatValidateItem = (_a = Reflect.get(flatRules, rule.path)) !== null && _a !== void 0 ? _a : [];
                    var flatValidateItems = Array.isArray(flatValidateItem) ? flatValidateItem : [flatValidateItem];
    ...
    getLocaleRules: function (rules, options) {
        var _a;
        if (options === void 0) { options = {}; }
        var parsedRules = validateUtil.parseRules(rules, {}, options);
        var flatRules = {};
        var localeRules = validateUtil.recursiveGetLocaleRules(parsedRules, flatRules, options);
        if ((_a = options.flat) !== null && _a !== void 0 ? _a : false) {
            return flatRules;
        }
        return localeRules;
    },
     ...
     * @returns 校验规则
     */
    getRules: function (rules, options) {
        if (options === void 0) { options = {}; }
    ...
    parseRules: function (rules, initialRules, options) {
        ...
        var mergedRules = (0, reduce_1.default)(rules, function (result, rule, fieldKey) {
            var _a, _b;
            var loadedRules = [];
            (Array.isArray(rule) ? rule : [rule]).forEach(function (option) {
                loadedRules.push.apply(loadedRules, validateUtil.parseToRules(tslib_1.__assign({ path: fieldKey }, option)));
            });
            ...
            return result;
        }, (0, isEmpty_1.default)(initialRules) ? {} : validateUtil.parseRules(initialRules, {}));
        return validateUtil.filterRules(mergedRules, (_a = options === null || options === void 0 ? void 0 : options.settings) !== null && _a !== void 0 ? _a : {});
    },
    /**
     * 解析校验规则
     * @param opts 校验规则
    ...
    parseToRules: function (opts) {
        var rules = [];
        var options = (0, cloneDeep_1.default)(opts);
        if (options.message) {
            ...
            if (isPresent(options.regexpKey) || isPresent(options.pattern) || isPresent(options.asyncValidator)) {
                var ruleRegexpKey = (0, cloneDeep_1.default)(options);
            ...
            if (isPresent(options.enum)) {
                var ruleEnum = (0, cloneDeep_1.default)(options);
            ...
            if (isPresent(options.len)) {
                var ruleLen = (0, cloneDeep_1.default)(options);
                delete ruleLen.fields;
                delete ruleLen.defaultField;
                if (options.lengthMode === 'byte') {
                    var byteLen_1 = options.len;
                    ruleLen.validator = function (_rule, value, callback) {
                        if (typeof value === 'string' && string_util_1.default.displayByteLength(value) !== byteLen_1) {
                            callback(new Error(validateUtil.getErrorDataJSON({
                                rules: { len: byteLen_1 },
            ...
            if (isPresent(options.min) && isPresent(options.max)) {
                var ruleMinMax = (0, cloneDeep_1.default)(options);
                delete ruleMinMax.fields;
                delete ruleMinMax.defaultField;
                if (options.lengthMode === 'byte') {
                    var byteMin_1 = options.min;
                    var byteMax_1 = options.max;
                    ruleMinMax.validator = function (_rule, value, callback) {
                        if (typeof value === 'string') {
                            var byteLength = string_util_1.default.displayByteLength(value);
                            if (byteLength < byteMin_1 || byteLength > byteMax_1) {
                                callback(new Error(validateUtil.getErrorDataJSON({
                                    rules: { min: byteMin_1, max: byteMax_1 },
            ...
            if (isPresent(options.min)) {
                var ruleMin = (0, cloneDeep_1.default)(options);
                delete ruleMin.fields;
                delete ruleMin.defaultField;
                if (options.lengthMode === 'byte') {
                    var byteMin_2 = options.min;
                    ruleMin.validator = function (_rule, value, callback) {
                        if (typeof value === 'string' && string_util_1.default.displayByteLength(value) < byteMin_2) {
                            callback(new Error(validateUtil.getErrorDataJSON({
                                rules: { min: byteMin_2 },
            ...
            if (isPresent(options.max)) {
                var ruleMax = (0, cloneDeep_1.default)(options);
                delete ruleMax.fields;
                delete ruleMax.defaultField;
                if (options.lengthMode === 'byte') {
                    var byteMax_2 = options.max;
                    ruleMax.validator = function (_rule, value, callback) {
                        if (typeof value === 'string' && string_util_1.default.displayByteLength(value) > byteMax_2) {
                            callback(new Error(validateUtil.getErrorDataJSON({
                                rules: { max: byteMax_2 },
            ...
            if (isPresent(options.pattern)) {
                var rulePattern = (0, cloneDeep_1.default)(options);
            ...
            if (isPresent(options.whitespace)) {
                var ruleWhitespace = (0, cloneDeep_1.default)(options);
            ...
            if (options.defaultField || options.fields) {
                var ruleFields = (0, cloneDeep_1.default)(options);
            ...
            if (options.required) {
                var ruleRequired = (0, cloneDeep_1.default)(options);
                ...
                var omitKeys = ['path', 'data', 'type', 'subType'];
                if (!(0, isEmpty_1.default)((0, pick_1.default)((0, omit_1.default)(options, omitKeys), avaliableKeys))) {
                    rules.push(validateUtil.parseRule(options));
                }
            }
            if (isPresent(options.transformers) || typeof options.transform === 'function') {
                var ruleTransformers = (0, cloneDeep_1.default)(options);
     ...
     * @returns 校验规则
     */
    parseRule: function (options, parseRuleOptions) {
        var _this = this;
        var _a, _b, _c;
        if (parseRuleOptions === void 0) { parseRuleOptions = {}; }
        var path = (_a = options === null || options === void 0 ? void 0 : options.path) !== null && _a !== void 0 ? _a : '';
        var type = (_b = options === null || options === void 0 ? void 0 : options.type) !== null && _b !== void 0 ? _b : (options.fields ? 'object' : 'string');
        var rule = tslib_1.__assign(tslib_1.__assign({}, options), { type: type, path: path });
        var message = (function () {
            var _a;
            var pickedRules = (0, pick_1.default)(options, SIMPLE_RULE_KEYS);
        ...
        if (parseRuleOptions.parseAsyncValidator) {
            var asyncValidator = (function () {
                ...
                var regexp = (function () {
                    ...
                    return regexpKey ? (0, get_1.default)(format_util_1.regExps, regexpKey) : undefined;
                })();
                var regexpReversed = (_a = options === null || options === void 0 ? void 0 : options.regexpReversed) !== null && _a !== void 0 ? _a : false;
                if (!regexp && options.asyncValidator === undefined) {
                    return undefined;
                }
                return function (rule, value, callback, source, option) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        if (parseRuleOptions.parseSubFields) {
            if (rule.defaultField) {
                var defaultFields = Array.isArray(rule.defaultField) ? rule.defaultField : rule.defaultField ? [rule.defaultField] : [];
                var defaultFieldType = (_c = defaultFields[0]) === null || _c === void 0 ? void 0 : _c.type;
                if (defaultFieldType === 'object') {
                    defaultFields.forEach(function (defaultField) {
                        defaultField.path = path;
                        if (defaultField.fields) {
                            defaultField.fields = (0, reduce_1.default)(defaultField.fields, function (result, field, fieldKey) {
                                var fields = [];
                                (Array.isArray(field) ? field : [field]).forEach(function (field) {
                                    fields.push.apply(fields, validateUtil.parseToRules(tslib_1.__assign({ path: "".concat(path, ".").concat(fieldKey) }, field)));
                                });
                    ...
                    rule.defaultField = (0, reduce_1.default)(defaultFields, function (result, defaultField) {
                        defaultField.path = "".concat(path, ".").concat(exports.ARRAY_ITEMS_BASIC_TYPE_KEY);
                        result.push.apply(result, validateUtil.parseToRules(tslib_1.__assign({ path: "".concat(path, ".").concat(exports.ARRAY_ITEMS_BASIC_TYPE_KEY) }, defaultField)));
                        return result;
                    }, []);
                }
            }
            if (options.fields) {
                rule.fields = (0, reduce_1.default)(options.fields, function (result, field, fieldKey) {
                    var fields = [];
                    (Array.isArray(field) ? field : [field]).forEach(function (field) {
                        fields.push.apply(fields, validateUtil.parseToRules(tslib_1.__assign({ path: "".concat(path, ".").concat(fieldKey) }, field)));
                    });
    ...
    collectRulesRequiredAssign: function (requires, rules) {
        Object.keys(rules).forEach(function (fieldKey) {
            ...
            fieldRules.forEach(function (rule, ruleIndex) {
                var _a;
                if (ruleIndex === 0 && rule.path && (0, last_1.default)((_a = requires[rule.path]) !== null && _a !== void 0 ? _a : [])) {
                    rule.required = true;
    ...
    normalizeRules: function (rules, options) {
        ...
        var pureRules = (0, cloneDeep_1.default)(rules);
...
var Validator = /** @class */ (function () {
    ...
    Validator.prototype.validate = function (data, options, callback) {
        ...
        return validateUtil.validate(this.rules, data, tslib_1.__assign(tslib_1.__assign({ model: this.model }, options), { settings: settings }), callback);
    };
    /**
     * 获取国际化规则
     * @param options 选项
    ...
    Validator.prototype.getLocaleRules = function (options) {
        var _a;
        var settings = (0, deepmerge_1.default)(this.settings, (_a = options === null || options === void 0 ? void 0 : options.settings) !== null && _a !== void 0 ? _a : {});
        return validateUtil.getLocaleRules(this.rules, tslib_1.__assign(tslib_1.__assign({}, options), { settings: settings }));
    };
    Validator.prototype.getRules = function (options) {
        var _a;
        var settings = (0, deepmerge_1.default)(this.settings, (_a = options === null || options === void 0 ? void 0 : options.settings) !== null && _a !== void 0 ? _a : {});
        return validateUtil.getRules(this.rules, tslib_1.__assign(tslib_1.__assign({}, options), { settings: settings }));
    };
    /**
     * 合并设置
     * @param settings 设置
    ...
    Validator.prototype.wrapRules = function (options) {
        ...
        var validator = override ? this : (0, cloneDeep_1.default)(this);
    ...
    Validator.prototype.omitRules = function (options) {
        ...
        var override = (_a = options.override) !== null && _a !== void 0 ? _a : false;
        var validator = override ? this : (0, cloneDeep_1.default)(this);
        validator.rules = (0, omit_1.default)(validator.rules, options.fieldKeys);
        return validator;
    };
    return Validator;
}());
