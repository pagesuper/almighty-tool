...
var validateUtil = {
    ...
    getRule: function (options) {
        ...
        var message = (_b = options === null || options === void 0 ? void 0 : options.message) !== null && _b !== void 0 ? _b : "".concat(options.regexpReversed ? 'InvalidReversed' : 'Invalid', ":").concat((_c = options.regexpKey) !== null && _c !== void 0 ? _c : 'format');
        ...
        var rule = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, options), { type: type, message: message, asyncValidator: asyncValidator });
        if (typeof options.requiredFn === 'function') {
            rule.requiredFn = function (opts) {
                var _a, _b, _c;
                if (typeof options.requiredFn === 'function') {
                    return (_b = (_a = options === null || options === void 0 ? void 0 : options.requiredFn) === null || _a === void 0 ? void 0 : _a.call(options, opts)) !== null && _b !== void 0 ? _b : false;
                }
                return (_c = rule.required) !== null && _c !== void 0 ? _c : false;
            };
