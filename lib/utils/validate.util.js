...
var validateUtil = {
        ...
        Object.keys(rules).forEach(function (fieldKey) {
            ...
            fieldRules.forEach(function (rule) {
                ...
                if (rule.fields) {
                    ...
                    var defaultFields_1 = Array.isArray(rule.defaultField) ? rule.defaultField : [rule.defaultField];
    ...
    getLocaleRules: function (rules, options) {
        ...
        var flat = (_a = options.flat) !== null && _a !== void 0 ? _a : false;
        if (flat) {
            return flatRules;
        }
        return localeRules;
    ...
    parseRule: function (options) {
        ...
        if (rule.defaultField) {
            var defaultFields = Array.isArray(rule.defaultField) ? rule.defaultField : [rule.defaultField];
            var defaultFieldType = defaultFields[0].type;
