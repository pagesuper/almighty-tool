...
var validateUtil = {
    ...
    validate: function (rules, values, options, callback) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        var model, transformedValues, schema, error_1;
        var _a, _b;
        return (0, tslib_1.__generator)(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, schema.validate(values, (0, deepmerge_1.default)({ messages: defaultMessages }, options !== null && options !== void 0 ? options : {}), callback)];
                case 2:
                    _c.sent();
                    return [2 /*return*/, {
                            success: true,
