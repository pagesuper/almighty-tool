...
function getMessageJSON(messageJSON) {
    ...
    getErrors: function (error, options) {
        ...
        if (typeof error === 'object' && error !== null && 'errors' in error) {
            return Reflect.get(error, 'errors').map(function (err) {
                return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, lodash_1.default.pick(err, ['field', 'fieldValue'])), { messageData: validateUtil.parseMessageJSON(err.message), message: validateUtil.getErrorMessage(err.message, options), model: model });
            });
        }
        return [
            {
        ...
        Object.keys(rules).forEach(function (fieldKey) {
            ...
            (Array.isArray(fieldRules) ? fieldRules : [fieldRules]).forEach(function (rule) {
                if (i18n && typeof i18n.t === 'function' && typeof rule.message === 'string') {
                    var messageJSON = validateUtil.parseMessageJSON(rule.message);
