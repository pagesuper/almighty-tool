        ...
        function doTransform(values, parentPath) {
            return lodash_1.default.transform(values, function (result, value, key) {
                ...
                if (typeof value === 'object') {
                    if (Array.isArray(value)) {
                        result[key] = value.map(function (item) {
                            if (transform === null || transform === void 0 ? void 0 : transform.length) {
                                return transform.reduce(function (value, transform) { return transform(value); }, item);
                            }
                    ...
                    if (transform === null || transform === void 0 ? void 0 : transform.length) {
                        result[key] = transform.reduce(function (value, transform) { return transform(value); }, value);
                    }
                    else {
                        result[key] = value;
                    }
    ...
    parseToRules: function (opts) {
        ...
        if (options.message) {
            ...
            if (isPresent(options.regexpKey)) {
                rules.push(validateUtil.getRule((0, tslib_1.__assign)({}, options)));
            ...
            if (isPresent(options.required)) {
                rules.unshift(validateUtil.getRule((0, tslib_1.__assign)({}, options)));
