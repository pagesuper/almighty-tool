...
var validateUtil = {
    ...
    getSchema: function (rules, options) {
        var _a;
        var pureRules = rules instanceof async_validator_1.default ? rules.rules : rules;
        return new async_validator_1.default(validateUtil.normalizeRules(validateUtil.getRules((_a = options === null || options === void 0 ? void 0 : options.rules) !== null && _a !== void 0 ? _a : {}, validateUtil.getRules(pureRules, {}))));
    },
    getErrorMessage: function (error, options) {
        var _a, _b;
        var i18n = (_a = options === null || options === void 0 ? void 0 : options.i18n) !== null && _a !== void 0 ? _a : i18n_1.i18nConfig.i18n;
        ...
        return (0, tslib_1.__generator)(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, {
                            success: false,
                            errors: validateUtil.getErrors(error_1, { model: model, i18n: (_b = options === null || options === void 0 ? void 0 : options.i18n) !== null && _b !== void 0 ? _b : i18n_1.i18nConfig.i18n }),
                        }];
    ...
    getRule: function (options) {
        ...
        var message = (function () {
            var _a;
            var pickedRules = lodash_1.default.pick(options, ['min', 'max', 'len', 'range']);
            if (options.message) {
