                ...
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, new ValidateResponseInstance({
                                success: false,
                                values: transformedValues,
                                errors: validateUtil.getErrors(error_1, { model: model, i18n: (_c = options === null || options === void 0 ? void 0 : options.i18n) !== null && _c !== void 0 ? _c : index_1.i18nConfig.i18n, lang: options === null || options === void 0 ? void 0 : options.lang }),
                            })];
