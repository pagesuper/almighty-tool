...
var validateUtil = {
    ...
    getErrors: function (error, options) {
        ...
        if (typeof error === 'object' && error !== null && 'errors' in error) {
            return Reflect.get(error, 'errors').map(function (err) {
                var field = (0, lodash_es_1.get)(err, 'field');
                var fieldValue = field ? (0, lodash_es_1.get)(values, field) : undefined;
                return {
                    field: field,
        ...
        return [
            {
                ...
                fieldValue: (_c = options === null || options === void 0 ? void 0 : options.fieldValue) !== null && _c !== void 0 ? _c : ((options === null || options === void 0 ? void 0 : options.field) ? (0, lodash_es_1.get)(values, options.field) : undefined),
                model: model,
            },
        ];
    },
    ...
    transform: function (values, rules) {
        ...
        function doTransform(values, parentPath) {
            ...
            return (0, lodash_es_1.transform)(values, function (result, value, key) {
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        usingValues = (0, lodash_es_1.omit)((options === null || options === void 0 ? void 0 : options.pickKeys) ? (0, lodash_es_1.pick)(values, options.pickKeys) : values, (_b = options === null || options === void 0 ? void 0 : options.omitKeys) !== null && _b !== void 0 ? _b : []);
    ...
    recursiveGetLocaleRules: function (rules, flatRules, options) {
        ...
        Object.keys(rules).forEach(function (fieldKey) {
            ...
            var defaultFields = (0, lodash_es_1.reduce)(fieldRules, function (result, rule) {
            ...
            fieldRules.forEach(function (rule) {
                ...
                if (rule.path) {
                    var flatRule = (0, lodash_es_1.cloneDeep)(rule);
    ...
    parseRules: function (rules, initialRules, options) {
        ...
        var mergedRules = (0, lodash_es_1.reduce)(rules, function (result, rule, fieldKey) {
            var _a, _b;
            var loadedRules = [];
            ...
            return result;
        }, (0, lodash_es_1.isEmpty)(initialRules) ? {} : validateUtil.parseRules(initialRules, {}));
    ...
    parseToRules: function (opts) {
        var rules = [];
        var options = (0, lodash_es_1.cloneDeep)(opts);
        if (options.message) {
            ...
            if (isPresent(options.regexpKey) || isPresent(options.pattern) || isPresent(options.asyncValidator)) {
                var ruleRegexpKey = (0, lodash_es_1.cloneDeep)(options);
            ...
            if (isPresent(options.enum)) {
                var ruleEnum = (0, lodash_es_1.cloneDeep)(options);
            ...
            if (isPresent(options.len)) {
                var ruleLen = (0, lodash_es_1.cloneDeep)(options);
            ...
            if (isPresent(options.min) && isPresent(options.max)) {
                var ruleMinMax = (0, lodash_es_1.cloneDeep)(options);
            ...
            if (isPresent(options.min)) {
                var ruleMin = (0, lodash_es_1.cloneDeep)(options);
            ...
            if (isPresent(options.max)) {
                var ruleMax = (0, lodash_es_1.cloneDeep)(options);
            ...
            if (isPresent(options.pattern)) {
                var rulePattern = (0, lodash_es_1.cloneDeep)(options);
            ...
            if (isPresent(options.whitespace)) {
                var ruleWhitespace = (0, lodash_es_1.cloneDeep)(options);
            ...
            if (options.defaultField || options.fields) {
                var ruleFields = (0, lodash_es_1.cloneDeep)(options);
            ...
            if (options.required) {
                var ruleRequired = (0, lodash_es_1.cloneDeep)(options);
                ...
                if (!(0, lodash_es_1.isEmpty)((0, lodash_es_1.pick)((0, lodash_es_1.omit)(options, omitKeys), avaliableKeys))) {
                    rules.push(validateUtil.parseRule(options));
                }
            }
            if (isPresent(options.transformers) || typeof options.transform === 'function') {
                var ruleTransformers = (0, lodash_es_1.cloneDeep)(options);
    ...
    parseRule: function (options, parseRuleOptions) {
        ...
        var message = (function () {
            var _a;
            var pickedRules = (0, lodash_es_1.pick)(options, SIMPLE_RULE_KEYS);
        ...
        if (parseRuleOptions.parseAsyncValidator) {
            var asyncValidator = (function () {
                ...
                var regexp = (function () {
                    ...
                    return regexpKey ? (0, lodash_es_1.get)(format_util_1.regExps, regexpKey) : undefined;
                })();
        ...
        if (parseRuleOptions.parseSubFields) {
                ...
                if (defaultFieldType === 'object') {
                    defaultFields.forEach(function (defaultField) {
                        ...
                        if (defaultField.fields) {
                            defaultField.fields = (0, lodash_es_1.reduce)(defaultField.fields, function (result, field, fieldKey) {
                                var fields = [];
                    ...
                    rule.defaultField = (0, lodash_es_1.reduce)(defaultFields, function (result, defaultField) {
            ...
            if (options.fields) {
                rule.fields = (0, lodash_es_1.reduce)(options.fields, function (result, field, fieldKey) {
                    var fields = [];
                    (Array.isArray(field) ? field : [field]).forEach(function (field) {
                        fields.push.apply(fields, validateUtil.parseToRules(tslib_1.__assign({ path: "".concat(path, ".").concat(fieldKey) }, field)));
                    });
    ...
    collectRulesRequiredAssign: function (requires, rules) {
        Object.keys(rules).forEach(function (fieldKey) {
            ...
            fieldRules.forEach(function (rule, ruleIndex) {
                var _a;
                if (ruleIndex === 0 && rule.path && (0, lodash_es_1.last)((_a = requires[rule.path]) !== null && _a !== void 0 ? _a : [])) {
                    rule.required = true;
    ...
    normalizeRules: function (rules, options) {
        ...
        var pureRules = (0, lodash_es_1.cloneDeep)(rules);
...
var Validator = /** @class */ (function () {
    ...
    Validator.prototype.wrapRules = function (options) {
        ...
        var validator = override ? this : (0, lodash_es_1.cloneDeep)(this);
    ...
    Validator.prototype.omitRules = function (options) {
        ...
        var override = (_a = options.override) !== null && _a !== void 0 ? _a : false;
        var validator = override ? this : (0, lodash_es_1.cloneDeep)(this);
        validator.rules = (0, lodash_es_1.omit)(validator.rules, options.fieldKeys);
        return validator;
    };
    return Validator;
}());
