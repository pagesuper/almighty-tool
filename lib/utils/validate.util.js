...
exports.Validator = exports.ValidateSchema = exports.ValidateResponseInstance = void 0;
        ...
        if (rule.defaultField) {
            ...
            if (defaultFieldType === 'object') {
                ...
                rule.defaultField = lodash_1.default.reduce(defaultFields, function (result, defaultField) {
                    defaultField.path = "".concat(path, ".items");
                    result.push.apply(result, validateUtil.parseToRules((0, tslib_1.__assign)({ path: "".concat(path, ".items") }, defaultField)));
                    return result;
                }, []);
            }
        }
