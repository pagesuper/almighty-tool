...
var validateUtil = {
    ...
    getErrors: function (error, options) {
        ...
        if (typeof error === 'object' && error !== null && 'errors' in error) {
            return Reflect.get(error, 'errors').map(function (err) {
                var field = lodash_1.default.get(err, 'field');
                var fieldValue = field ? lodash_1.default.get(values, field) : undefined;
                return {
                    field: field,
        ...
        return [
            {
                ...
                fieldValue: (_c = options === null || options === void 0 ? void 0 : options.fieldValue) !== null && _c !== void 0 ? _c : ((options === null || options === void 0 ? void 0 : options.field) ? lodash_1.default.get(values, options.field) : undefined),
                model: model,
            },
        ];
    },
            ...
            return (0, tslib_1.__generator)(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        usingValues = lodash_1.default.omit((options === null || options === void 0 ? void 0 : options.pickKeys) ? lodash_1.default.pick(values, options.pickKeys) : values, (_b = options === null || options === void 0 ? void 0 : options.omitKeys) !== null && _b !== void 0 ? _b : []);
                    ...
                    case 3:
                        error_1 = _d.sent();
                        mergedValues = deepmerge_1.default.all([values, transformedValues]);
                        return [2 /*return*/, new ValidateResponseInstance({
                                success: false,
                                values: mergedValues,
    ...
    recursiveGetLocaleRules: function (rules, flatRules, options) {
        ...
        Object.keys(rules).forEach(function (fieldKey) {
            ...
            var defaultFields = lodash_1.default.reduce(fieldRules, function (result, rule) {
            ...
            fieldRules.forEach(function (rule) {
                ...
                if (rule.path) {
                    var flatRule = lodash_1.default.cloneDeep(rule);
    ...
    parseToRules: function (opts) {
        ...
        if (options.message) {
            ...
            if (isPresent(options.regexpKey) || isPresent(options.pattern) || isPresent(options.asyncValidator)) {
                var ruleRegexpKey = lodash_1.default.cloneDeep(options);
            ...
            if (isPresent(options.enum)) {
                var ruleEnum = lodash_1.default.cloneDeep(options);
            ...
            if (isPresent(options.len)) {
                var ruleLen = lodash_1.default.cloneDeep(options);
            ...
            if (isPresent(options.min) && isPresent(options.max)) {
                var ruleMinMax = lodash_1.default.cloneDeep(options);
            ...
            if (isPresent(options.min)) {
                var ruleMin = lodash_1.default.cloneDeep(options);
            ...
            if (isPresent(options.max)) {
                var ruleMax = lodash_1.default.cloneDeep(options);
            ...
            if (isPresent(options.pattern)) {
                var rulePattern = lodash_1.default.cloneDeep(options);
            ...
            if (isPresent(options.whitespace)) {
                var ruleWhitespace = lodash_1.default.cloneDeep(options);
            ...
            if (options.defaultField || options.fields) {
                var ruleFields = lodash_1.default.cloneDeep(options);
            ...
            if (options.required) {
                var ruleRequired = lodash_1.default.cloneDeep(options);
                ...
                if (!lodash_1.default.isEmpty(lodash_1.default.pick(lodash_1.default.omit(options, omitKeys), avaliableKeys))) {
                    rules.push(validateUtil.parseRule(options));
                }
            }
            if (isPresent(options.transformers) || typeof options.transform === 'function') {
                var ruleTransformers = lodash_1.default.cloneDeep(options);
    ...
    parseRule: function (options, parseRuleOptions) {
        ...
        var rule = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, options), { type: type, path: path });
        ...
        if (parseRuleOptions.parseAsyncValidator) {
            var asyncValidator = (function () {
                ...
                var regexp = (function () {
                    ...
                    return regexpKey ? lodash_1.default.get(format_util_1.regExps, regexpKey) : undefined;
                })();
        ...
        if (parseRuleOptions.parseSubFields) {
            if (rule.defaultField) {
                ...
                if (defaultFieldType === 'object') {
                    ...
                    rule.defaultField = lodash_1.default.reduce(defaultFields, function (result, defaultField) {
                        defaultField.path = "".concat(path, ".").concat(exports.ARRAY_ITEMS_BASIC_TYPE_KEY);
                        result.push.apply(result, validateUtil.parseToRules((0, tslib_1.__assign)({ path: "".concat(path, ".").concat(exports.ARRAY_ITEMS_BASIC_TYPE_KEY) }, defaultField)));
                        return result;
                    }, []);
                }
            }
...
var Validator = /** @class */ (function () {
    ...
    Validator.prototype.getRules = function (options) {
        var _a;
        var settings = (0, deepmerge_1.default)(this.settings, (_a = options === null || options === void 0 ? void 0 : options.settings) !== null && _a !== void 0 ? _a : {});
        return validateUtil.getRules(this.rules, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, options), { settings: settings }));
    };
    /**
     * 合并设置
     * @param settings 设置
