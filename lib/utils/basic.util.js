...
var basicUtil = {
    ...
    /** 树遍历 */
    treeErgodic: function (treeChildren, callFn) {
    ...
    /** 获取两个对象的差异 */
    getDifferences: function (obj1, obj2, path) {
        if (path === void 0) { path = []; }
        ...
        if (Array.isArray(obj1) && Array.isArray(obj2)) {
            ...
            for (var i = 0; i < maxLength; i++) {
                if (i >= obj1.length || i >= obj2.length || !areEqual(obj1[i], obj2[i])) {
                    differences = differences.concat(basicUtil.getDifferences(obj1[i], obj2[i], (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], path, true), [i.toString()], false)));
                }
            }
        }
            ...
            for (var _i = 0, _a = Array.from(keys); _i < _a.length; _i++) {
                var key = _a[_i];
                differences = differences.concat(basicUtil.getDifferences(obj1[key], obj2[key], (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], path, true), [key], false)));
            }
        }
