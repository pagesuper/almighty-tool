...
var stringUtil = {
    ...
    truncate: function (str, options) {
        ...
        if (str.length <= options.length)
            return str;
        // 解构配置项并设置默认值
        var length = options.length, _a = options.position, position = _a === void 0 ? 'end' : _a, _b = options.endChars, endChars = _b === void 0 ? 4 : _b, _c = options.omission, omission = _c === void 0 ? '...' : _c, _d = options.preserveWord, preserveWord = _d === void 0 ? false : _d;
