...
var i18n = {
    t: function (key, _values, locale) {
        switch (locale === null || locale === void 0 ? void 0 : locale.toLowerCase()) {
            case 'vi':
                return (0, get_1.default)(vi_1.default, key);
            case 'en':
                return (0, get_1.default)(en_1.default, key);
            case 'zh-cn':
            default:
                return (0, get_1.default)(zh_cn_1.default, key);
        }
    },
};
/** 日期格式化工具 */
    ...
    format: function (date, options) {
        ...
        if (date) {
            try {
                ...
                var now = options.now ? (0, dayjs_1.default)(options.now) : (0, dayjs_1.default)();
