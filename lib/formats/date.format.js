...
var vi_1 = tslib_1.__importDefault(require("../locales/vi"));
...
var i18n = {
    t: function (key, _values, locale) {
        switch (locale === null || locale === void 0 ? void 0 : locale.toLowerCase()) {
            case 'vi':
                return lodash_es_1.default.get(vi_1.default, key);
            case 'en':
                return lodash_es_1.default.get(en_1.default, key);
            case 'zh-cn':
            default:
                return lodash_es_1.default.get(zh_cn_1.default, key);
        }
    },
};
/** 日期格式化工具 */
