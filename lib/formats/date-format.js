...
var DEFAULT_I18N_KEY = 'kinlong-lib/formats/date-format#i18n';
var i18n = {
...
var dateFormat = {
    ...
    format: function (date, options) {
        ...
        if (date) {
            ...
            var locale = _i18n.t('KinlongLib.DateFormat.locale').toString();
            ...
            switch (options.formatter) {
                ...
                case 'shortStep':
                    if (now.startOf('day').diff(day) <= 0 && now.add(1, 'day').startOf('day').diff(day) > 0) {
                        ...
                        return day
                            .locale(locale)
                            .format(_i18n.t("KinlongLib.DateFormat.".concat(options.formatter, ".today")).toString());
                    }
                        ...
                        return day
                            .locale(locale)
                            .format(_i18n.t("KinlongLib.DateFormat.".concat(options.formatter, ".tomorrow")).toString());
                    }
                        ...
                        return day
                            .locale(locale)
                            .format(_i18n.t("KinlongLib.DateFormat.".concat(options.formatter, ".yesterday")).toString());
                    }
                        ...
                        return day
                            .locale(locale)
                            .format(_i18n.t("KinlongLib.DateFormat.".concat(options.formatter, ".thisYear")).toString());
                    }
                    return day
                        .locale(locale)
                        .format(_i18n.t("KinlongLib.DateFormat.".concat(options.formatter, ".longAgo")).toString());
                case 'fromNow':
    ...
    getFormatTemplate: function (formatter) {
        ...
        var _i18n = general_1.default.getDefault(DEFAULT_I18N_KEY) || i18n;
        return _i18n.t("KinlongLib.DateFormat.formats.".concat(formatter));
    },
    /** 设置默认的i18n对象 */
