...
var DEFAULT_HEADERS_KEY = 'kinlong-lib/common/network#DefaultHeaders';
var DEFAULT_INTERCEPT_KEY = 'kinlong-lib/common/network#DefaultIntercept';
var DEFAULT_CATCHES_KEY = 'kinlong-lib/common/network#DefaultCatchesKey';
...
var network = {
    ...
    normalizeRequestOptions: function (options) {
        ...
        return tslib_1.__assign(tslib_1.__assign({}, lodash_1.default.pick(options, [
            'dataType',
            'responseType',
            'transformRequest',
            'transformResponse',
